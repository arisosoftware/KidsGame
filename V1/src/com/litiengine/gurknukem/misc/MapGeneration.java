...
public final class MapGeneration {
	...
	public static IMap generateRandomizedMap() {
		...
		// ---------------
		// always generate maps in a try-with-resource block to ensure that the map is
		// "finished" when the creation is done
		try (MapGenerator generator = Resources.maps().generate(MapOrientations.ORTHOGONAL, MAP_NAME, MAP_WIDTH,
				MAP_HEIGHT, TILE_WIDTH, TILE_HEIGHT, Resources.tilesets().get("tileset.tsx"))) {
