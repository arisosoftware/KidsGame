...
//TODO:Fix sound resource issus   public static final Sound SETTING_CHANGE_SOUND = Resources.sounds().get("swing1.ogg");
	...
	protected void updateFocus() {
		...
		if (this.isVisible()) {
			// TODO:Fix sound resource issus Game.audio().playSound(SETTING_CHANGE_SOUND);
		}
	}
}
