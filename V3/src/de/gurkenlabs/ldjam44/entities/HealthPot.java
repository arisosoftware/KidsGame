...
public class HealthPot extends Prop implements IUpdateable {
	...
	@Override
	public void update() {
		if (this.getBoundingBox().intersects(Player.instance().getCollisionBox()) && Player.instance().getHitPoints()
				.getCurrentValue() < Player.instance().getHitPoints().getMaxValue()) {
