...
public class Slave extends Mob {
	...
	// private static final Sound[] deathSounds = new Sound[] {
	// Resources.sounds().get("slave-death1.ogg"),
	// Resources.sounds().get("slave-death2.ogg"),
	// Resources.sounds().get("slave-death3.ogg"),
	// Resources.sounds().get("slave-death4.ogg"),
	// Resources.sounds().get("slave-death5.ogg"),
	// Resources.sounds().get("slave-death6.ogg") };
	...
	public boolean canCollideWith(final ICollisionEntity otherEntity) {
		return !(otherEntity instanceof Player) && !(otherEntity instanceof Slave) && !(otherEntity instanceof Enemy)
				&& !(otherEntity instanceof DecorMob);
	}
