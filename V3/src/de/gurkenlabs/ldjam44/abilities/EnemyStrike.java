...
public class EnemyStrike extends OffensiveAbility {
	//TODO:Fix sound resource issus  private static final Sound[] strikeSounds = new Sound[] { Resources.sounds().get("enemy-strike1.ogg"),			Resources.sounds().get("enemy-strike2.ogg") };
	...
	public EnemyStrike(Creature executor) {
		...
		this.onCast(e -> {
			...
			double angle = GeometricUtilities.calcRotationAngleInDegrees(this.getOrigin(),
			...
			//TODO:Fix sound resource issus 			Game.audio().playSound(ArrayUtilities.getRandom(strikeSounds));
		});
	}
