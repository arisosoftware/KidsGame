...
public interface IEntitySpawner<T extends IEntity> extends IUpdateable {
	 ...
	 * <ul>
	 * <li><b>ALLSPAWNPOINTS</b>: the specified spawnAmount is spawned at each of
	 * the SpawnPoints individually</li>
	 * <li><b>ONERANDOMSPAWNPOINT</b>: the specified spawnAmount is spawned at one
	 * random SpawnPoint</li>
	 * <li><b>RANDOMSPAWNPOINTS</b>: the specified spawnAmount is distributed
	 * equally to all of the SpawnPoints</li>
	 * </ul>
	 */
	...
	/**
	 * Gets the delay in milliseconds between spawning individual Entities of one
	 * wave.
	 *
