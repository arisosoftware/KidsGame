...
public abstract class MapObjectLoader implements IMapObjectLoader {
	...
	/**
	 * Loads engine default properties to the specified <code>IEntity</code>
	 * instance:
	 * <ul>
	 * <li>width, height</li>
	 * <li>mapId</li>
	 ...
	 * <li>tags</li>
	 * </ul>
	 * Also, this supports predefined <code>CustomMapObjectProperties</code>. It
	 * loads the specified custom properties via reflection.
	 * 
	 * @param entity    The entity instance that will be initialized.
	 * @param mapObject The mapObject that provides the static information for the
	 *                  new entity.
	 * 
	 * @see TmxProperty
	 */
