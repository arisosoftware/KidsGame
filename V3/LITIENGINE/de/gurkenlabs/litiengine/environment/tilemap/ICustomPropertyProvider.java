...
/**
 * The Interface ICustomPropertyProvider is providing methods to get and set
 * custom properties.
 */
public interface ICustomPropertyProvider {
	 ...
	 * @return true if a custom property with the given name is present. False
	 *         otherwise.
	 */
	...
	/**
	 * Gets the string value of the custom property with the provided name. If the
	 * value is null, the provided default value is used as a fallback.
	 *
	 * @param propertyName the name of the custom property
	 * @param defaultValue the fallback value in case the property value is null.
	 * @return the string value of the custom property, if present. Otherwise, the
	 ...
	 * @throws NoSuchElementException if the custom property does not exist
	 * @throws NumberFormatException  if the custom property is not an integer or is
	 *                                not in range for an {@code int}
	 */
	public int getIntValue(String propertyName);

	/**
	 * Gets the int value of the custom property with the provided name. If the
	 * value is null, the provided default value is used as a fallback.
	 *
	 * @param propertyName the name of the custom property
	 * @param defaultValue the fallback value in case the property value is null.
	 * @return the int value of the custom property, if present. Otherwise, the
	 *         provided default value is returned.
	 */
	...
	/**
	 * Gets the long value of the custom property with the provided name. If the
	 * value is null, the provided default value is used as a fallback.
	 *
	 * @param propertyName the name of the custom property
	 * @param defaultValue the fallback value in case the property value is null.
	 * @return the long value of the custom property, if present. Otherwise, the
	 *         provided default value is returned.
	 */
	 ...
	 * @throws NoSuchElementException if the custom property does not exist
	 * @throws NumberFormatException  if the custom property is not an integer or is
	 *                                out of range for a {@code short}
	 */
	public short getShortValue(String propertyName);

	/**
	 * Gets the short value of the custom property with the provided name. If the
	 * value is null, the provided default value is used as a fallback.
	 *
	 * @param propertyName the name of the custom property
	 * @param defaultValue the fallback value in case the property value is null.
	 * @return the short value of the custom property, if present. Otherwise, the
	 *         provided default value is returned.
	 */
	 ...
	 * @throws NoSuchElementException if the custom property does not exist
	 * @throws NumberFormatException  if the custom property is not an integer or is
	 *                                out of range for a {@code byte}
	 */
	public byte getByteValue(String propertyName);

	/**
	 * Gets the byte value of the custom property with the provided name. If the
	 * value is null, the provided default value is used as a fallback.
	 *
	 * @param propertyName the name of the custom property
	 * @param defaultValue the fallback value in case the property value is null.
	 * @return the byte value of the custom property, if present. Otherwise, the
	 *         provided default value is returned.
	 */
	 ...
	 * @throws NoSuchElementException if the custom property does not exist
	 * @throws NumberFormatException  if the custom property is not a
	 *                                {@code boolean} value
	 */
	public boolean getBoolValue(String propertyName);

	/**
	 * Gets the boolean value of the custom property with the provided name. If the
	 * value is null, the provided default value is used as a fallback.
	 *
	 * @param propertyName the name of the custom property
	 * @param defaultValue the fallback value in case the property value is null.
	 * @return the boolean value of the custom property, if present. Otherwise, the
	 *         provided default value is returned.
	 */
	...
	/**
	 * Gets the float value of the custom property with the provided name. If the
	 * value is null, the provided default value is used as a fallback.
	 *
	 * @param propertyName the name of the custom property
	 * @param defaultValue the fallback value in case the property value is null.
	 * @return the float value of the custom property, if present. Otherwise, the
	 *         provided default value is returned.
	 */
	...
	/**
	 * Gets the double value of the custom property with the provided name. If the
	 * value is null, the provided default value is used as a fallback.
	 *
	 * @param propertyName the name of the custom property
	 * @param defaultValue the fallback value in case the property value is null.
	 * @return the double value of the custom property, if present. Otherwise, the
	 *         provided default value is returned.
	 */
	...
	/**
	 * Gets the color value of the custom property with the provided name. If the
	 * value is null, the provided default value is used as a fallback.
	 *
	 * @param propertyName the name of the custom property
	 * @param defaultValue the fallback value in case the property value is null.
	 * @return the color value of the custom property, if present. Otherwise, the
	 *         provided default value is returned.
	 */
	...
	/**
	 * Gets the enum value of the custom property with the provided name. If the
	 * value is null, the provided default value is used as a fallback.
	 *
	 * @param propertyName the name of the custom property
	 * @param defaultValue the fallback value in case the property value is null.
	 * @param enumType     a {@code Class} object for {@code <T>}
	 * @param <T>          the enum type to use
	 * @return the enum value of the custom property, if present. Otherwise, the
	 *         provided default value is returned.
	 */
	public <T extends Enum<T>> T getEnumValue(String propertyName, Class<T> enumType, T defaultValue);

	/**
	 * Gets the file value of the custom property with the provided name. If the
	 * property is not a file, {@code null} is returned instead.
	 *
	 * @param propertyName the name of the custom property
	...
	/**
	 * Gets the file value of the custom property with the provided name. If the
	 * value is null or the property is not a file, the provided default value is
	 * used as a fallback.
	 *
	 * @param propertyName the name of the custom property
	 * @param defaultValue the fallback value in case the property value is null.
	 * @return the file value of the custom property, if present. Otherwise, the
	 *         provided default value is returned.
	 */
	...
	/**
	 * Sets the value for the custom property with the given name to the given
	 * string.
	 *
	 * @param propertyName the name of the custom property
	 * @param value        the new value
	...
	/**
	 * Returns a {@code Map} view of the custom properties for this
	 * {@code ICustomPropertyProvider}.
	 *
	 * @return a {@code Map} view of the custom properties for this
	 *         {@code ICustomPropertyProvider}
	 */
	 ...
	 * Properties are added when they only exist in the provided properties, and
