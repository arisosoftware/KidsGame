...
public class MapObject extends CustomPropertyProvider implements IMapObject {
	...
	/**
	 * Copy Constructor for copying instances of MapObjects. This variant of the
	 * constructor will assign an entirely new ID to the newly created MapObject.
	 *
	 * @param mapObjectToBeCopied the MapObject we want to copy
	 */
	public MapObject(MapObject mapObjectToBeCopied) {
		...
		this.polyline = (mapObjectToBeCopied.getPolyline() != null
				&& !mapObjectToBeCopied.getPolyline().getPoints().isEmpty())
						? new Polyline(mapObjectToBeCopied.getPolyline())
						: null;
	...
	/**
	 * Copy Constructor for copying instances of MapObjects. This variant of the
	 * constructor lets you decide if the copy instance will get the same ID as the
	 * old MapObject or get a new ID.
	 * 
	 * @param mapObjectToBeCopied the MapObject we want to copy
	 * @param keepID              decide if the new instance will adopt the old
	 *                            MapObject's ID or get a new, unique one.
	 */
	...
	private void afterUnmarshal(Unmarshaller u, Object parent) {
		// MapObjects don't necessarily have to be children of a layer. E.g. they can
		// also be children of a Blueprint.
