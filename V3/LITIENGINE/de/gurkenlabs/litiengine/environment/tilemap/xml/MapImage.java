...
public class MapImage extends CustomPropertyProvider implements IMapImage {
	...
	public MapImage(MapImage original) {
		...
		if (original.transparentcolor != null) {
			this.transparentcolor = new Color(original.transparentcolor.getRed(), original.transparentcolor.getGreen(),
					original.transparentcolor.getBlue(), original.transparentcolor.getAlpha());
		}
