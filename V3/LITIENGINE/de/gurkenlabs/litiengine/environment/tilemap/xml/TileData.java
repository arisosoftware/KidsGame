...
public class TileData {
	...
	/**
	 * This method processes the {@link XmlMixed} contents that were unmarshalled
	 * and extract either the string value containing the information about the
	 * layer of a set of {@link TileChunk}s if the map is infinite.
	 */
	...
	/**
	 * For infinite maps, the size of a tile layer depends on the
	 * <code>TileChunks</code> it contains.
	 */
