...
public class CustomProperty implements ICustomProperty {
	 ...
	 *
	 * @param propertyToBeCopied the Property we want to copy
	 */
	...
	public char getAsChar() {
		return this.value.charAt(0); // TODO Is this enough? Should it check if it's the right length and throw an
