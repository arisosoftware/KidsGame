...
public class Tileset extends CustomPropertyProvider implements ITileset {
	...
	public Dimension getTileDimension() {
		return this.sourceTileset != null ? this.sourceTileset.getTileDimension()
	...
	private void afterUnmarshal(Unmarshaller u, Object parent) {
		if (this.source == null) {
			...
			if (iter.hasNext()) {
				log.warning("tileset \"" + this.name + "\" had a tilecount attribute of " + this.tilecount
						+ " but had tile IDs going beyond that");
				while (iter.hasNext()) {
