...
public class Blueprint extends MapObject {
	/**
	 * Templates in this format typically come from the Tiled editor and only
	 * support a single MapObject.
	 */
	public static final String TEMPLATE_FILE_EXTENSION = "tx";

	/**
	 * Blueprint in this format support multiple map objects as children (extended
	 * template XML).
	 */
	 ...
	 * afterwards.
	 * 
	 * @return True if the ids for all {@link IMapObject}s of this {@link Blueprint}
