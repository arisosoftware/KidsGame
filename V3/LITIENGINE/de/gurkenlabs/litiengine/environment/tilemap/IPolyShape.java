...
public interface IPolyShape {
	 ...
	 * 
	 * <p>
	 * <i>To get a <code>Path2D</code> object, you should use <code>Map</code></i>
	 * </p>
	 * 
	...
	/**
	 * Tests for equality between two polylines. Two polylines are <i>equal</i> if
	...
	/**
	 * Computes a hash code for this polyline. A polyline's hash code is equal to
	 * the hash code of its points.
	 * 
