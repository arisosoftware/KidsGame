...
public interface IMapImage extends ICustomPropertyProvider {
	...
	/**
	 * Tests for equality between two map images. Two map images are <i>equal</i> if
	 * they have the same absolute source path and the same transparent color.
	 * 
	 * @param anObject The map image to test for equality with
	 * @return Whether this map image is equal to the provided map image, or
	 *         {@code false} if {@code anObject} is not a map image
	 */
	public boolean equals(Object anObject);

	/**
	 * Computes a hash code for this map image. The hash code for a map image is
	 * equal to the hash code of its absolute source path xor the hash code of its
	 * transparent color.
	 * 
