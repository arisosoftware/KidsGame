...
public interface IMapOrientation {
	...
	/**
	 * Determines the size required for all tiles within the given map to be drawn
	 * into an image. Tiles larger than the map's tile size may not fit within this
	 * size.
	 *
	...
	/**
	 * Determines the rendered location of a tile within the given {@code IMap},
	 * given the saved coordinates of the tile. The coordinates of the point
	 * returned are those of the bottom-left corner of the tile's image relative to
	 * the top-left corner of the rectangle in which tiles in the given map are
	 * drawn. The point returned by this method will not necessarily be contained
	...
	/**
	 * Creates a {@code Shape} for the tile at the given coordinates. The shapes
	 * returned by this method should reflect the intended shape of a tile in this
	 * orientation, and in general should not overlap.
	 *
	...
	/**
	 * Determines the bounding box for the tile at the given coordinates. A call to
	...
	/**
	 * Returns the shape of the tile containing the given coordinates. A call to
	 * this method is equivalent to calling
	...
	/**
	 * Returns the bounding box of the tile containing the given coordinates. A call
	 * to this method is equivalent to calling
	...
	/**
	 * Determines the coordinates of the tile containing the given point, as
	 * determined by {@link IMapOrientation#getShape(int, int, IMap)}.
	 *
	 * @param x   The X coordinate to contain
	 * @param y   The Y coordinate to contain
	 * @param map The {@code IMap} containing the tile
