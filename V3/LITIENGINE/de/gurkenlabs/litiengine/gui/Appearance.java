...
public class Appearance {
	...
	@Override
	public int hashCode() {
		return Objects.hash(this.textAntialiasing, this.transparentBackground, this.horizontalBackgroundGradient,
				this.borderRadius, this.borderColor, this.borderStyle, this.backgroundColor1, this.backgroundColor2,
				this.foreColor);
	}
	...
	/**
	 * Sets the {@link RenderingHints#KEY_TEXT_ANTIALIASING} settings for the
	 * rendered text.
	 * 
