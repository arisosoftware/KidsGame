...
public class NumberAdjuster extends TextFieldComponent {
	...
	public NumberAdjuster(final double x, final double y, final double width, final double height,
			final Spritesheet textBackground, final Spritesheet buttonBackground, final double lowerBound,
			final double upperBound, final double startValue, final double stepSize) {
	...
	@Override
	public void prepare() {
		ImageComponent buttonUp = new ImageComponent(this.getX() + this.getWidth(), this.getY(), this.getHeight() / 2,
				this.getHeight() / 2, this.getButtonSprite(), ARROW_UP.getText(), null);
		ImageComponent buttonDown = new ImageComponent(this.getX() + this.getWidth(),
				this.getY() + this.getHeight() / 2, this.getHeight() / 2, this.getHeight() / 2, this.getButtonSprite(),
				ARROW_DOWN.getText(), null);
