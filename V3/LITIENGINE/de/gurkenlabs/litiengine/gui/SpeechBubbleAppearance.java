...
public class SpeechBubbleAppearance extends Appearance {
	...
	@Override
	public int hashCode() {
		return Objects.hash(this.getBorderColor(), this.getPadding(), this.isRenderIndicator(), this.getForeColor(),
				this.getBackgroundColor1(), this.getBackgroundColor2(), this.isHorizontalBackgroundGradient(),
