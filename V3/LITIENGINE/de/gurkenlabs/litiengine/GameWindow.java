...
public final class GameWindow {
	...
	private void setResolution(Dimension dim) {
		Dimension insetAwareDimension = new Dimension(
				dim.width + this.hostControl.getInsets().left + this.hostControl.getInsets().right,
				dim.height + this.hostControl.getInsets().top + this.hostControl.getInsets().bottom);
