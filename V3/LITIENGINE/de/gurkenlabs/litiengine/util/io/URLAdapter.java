...
/**
 * This class allows for absolute and relative URLs to be unmarshalled as Java
 * URL objects.
 * 
...
public class URLAdapter extends XmlAdapter<String, URL> {
	...
	/**
	 * Constructs a new {@code URLAdapter}, with no additional properties. This
	 * constructor is called if no configured instance is available to an
	 * unmarshaller.
	 */
	public URLAdapter() {
		this(null);
	...
	/**
	 * Constructs a new {@code URLAdapter}, configured to use relative URLs using
	 * the supplied URL as a base.
	 * 
	 ...
	 * 
	 * @return The base URL used, or {@code null} if this instance has not been
	 *         configured for relative URLs
	 */
