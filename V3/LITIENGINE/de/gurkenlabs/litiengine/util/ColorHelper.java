...
public final class ColorHelper {
	...
	public static Color decode(String colorHexString, boolean solid) {
		...
		default:
			log.log(Level.SEVERE,
					...
					new Object[] { colorHexString, colorHexString.length(), HEX_STRING_LENGTH,
	 ...
	 * values (0-255). Smaller values will be forced to be 0 and larger values will
	 * result in 255.
	 * 
	...
	private static Color decodeHexStringWithAlpha(String hexString, boolean solid) {
		...
		// solid means that color alpha will basically create a darker version of the
		// base color
		if (solid) {
