...
public final class ReflectionUtilities {
			...
			if (method != null) {
				...
				for (final Field field : cls.getDeclaredFields()) {
					if (field.getName().equals(fieldName)
							&& (field.getType() == value.getClass() || isWrapperType(field.getType(), value.getClass())
	...
	public static <T> boolean setEnumPropertyValue(Class<T> cls, Object instance, final Field field,
	...
	public static <T> boolean setFieldValue(final Class<T> cls, final Object instance, final String fieldName,
			final String value) {
	...
	public static List<Method> getMethodsAnnotatedWith(final Class<?> type,
		...
		while (clazz != Object.class) { // need to iterated thought hierarchy in order to retrieve methods from above
			...
			// iterate though the list of methods declared in the class represented by class
