...
public abstract class ConfigurationGroup {
	 ...
	 * boolean, int, double, float, String and enum values. If you need to store any
	 * other object, you should overwrite this method as well as the
			...
			for (final Field field : this.getClass().getDeclaredFields()) {
				...
				if (field.getType().equals(boolean.class)) {
					...
					properties.setProperty(propertyKey,
							field.get(this) != null ? String.join(",", (String[]) field.get(this)) : "");
				} else if (field.getType().isEnum()) {
					Object val = field.get(this);
					final String value = val == null && field.getType().getEnumConstants().length > 0
