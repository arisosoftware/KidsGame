...
/**
 * This class contains all default <code>ConfigurationGroups</code> that are
 * provided by the LITIengine. Additionally, it can be used to register and
 * manage custom settings that are specific to your game.
 *
...
public final class GameConfiguration extends Configuration {
	...
	/**
	 * Gets the configuration group with all default graphics settings. Elements in
	 * this group will allow you to adjust the game's rendering behavior.
	 * 
