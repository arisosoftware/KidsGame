...
/**
 * A movement controller that supports keyboard input for horizontal entity
 * movement.
 *
...
public class PlatformingMovementController<T extends IMobileEntity> extends KeyboardEntityController<T> {
	 ...
	 * <code>EntityAction</code> on the related entity.
	 * <p>
	 * <i>Note that the entity needs to either specify a method with an
	 * <code>Action</code> annotation that corresponds to this identifier or it
	 * needs to explicitly register an <code>EntityAction</code>.</i>
	 * </p>
	 * 
