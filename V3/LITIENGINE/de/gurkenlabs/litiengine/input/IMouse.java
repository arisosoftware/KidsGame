...
/**
 * The Interface IMouse provides methods to manage mouse input in the
 * LITIengine.
 */
public interface IMouse extends MouseListener, MouseMotionListener, MouseWheelListener {
	 ...
	 * 
	 * @param grab True if the mouse should be grabbed to the
	 *             {@link RenderComponent}, otherwise false.
	 */
