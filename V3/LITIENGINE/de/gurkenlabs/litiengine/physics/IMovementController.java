...
/**
 * The Interface IMovementController is used for moving entities by applying
 * forces to them.
 */
public interface IMovementController extends IEntityController {
	 ...
	 *
	 * @param predicate the conditions that need to apply before moving. If they
	 *                  don't apply, the entity won't be moved.
	 */
	 ...
	 *
	 * @param cons the logic that will be called after the entity has been moved.
	 */
