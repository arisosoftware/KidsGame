...
public class GravityForce extends Force {
	...
	public Point2D getLocation() {
		return GeometricUtilities.project(this.getForceEntity().getCenter(), this.directionAngle,
				Math.max(this.forceEntity.getHeight(), this.forceEntity.getWidth() * 2 + this.getStrength()));
	}
