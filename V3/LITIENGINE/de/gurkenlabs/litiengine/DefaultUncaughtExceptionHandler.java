...
/**
 * Handles the uncaught exceptions that might occur while running a game or
 * application with the LITIengine.
 * <p>
 * It provides proper logging of the exception in a <code>crash.txt</code> file
 * in the game's root directory that can be further used to report the issue if
 * it's a generic one.
 * </p>
 * 
 * Depending on the configuration, the default behavior might force the game to
 * exit upon an unexpected exception which can be useful to detect problems in
 * your game early.
 * 
...
public class DefaultUncaughtExceptionHandler implements UncaughtExceptionHandler {
	...
	/**
	 * Indicates whether this hander currently exits the game upon an unhandled
	 * exception.
	 * 
	 * @return True if the game will exit upon an unhandled exception; otherwise
	 *         false.
	 */
	 ...
	 * 
	 * @param exit The flag that defines whether the game will exit upon an
	 *             unhandled exception.
	 */
