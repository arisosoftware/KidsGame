...
public final class GameTime implements EnvironmentLoadedListener {
	...
	/**
	 * Gets the time in milliseconds that has passed since the game has been
	 * started.<br>
	 * This uses the configured update rate to calculate the passed time from the
	 * specified ticks.
	 * 
	...
	/**
	 * Get the time in milliseconds that has passed since the current environment
	 * was loaded.
	 * 
	...
	/**
	 * Converts the specified ticks to milliseconds using the game loop's update
	 * rate.
	 * 
	...
	/**
	 * Converts the specified milliseconds to ticks using the game loop's update
	 * rate.
	 * 
