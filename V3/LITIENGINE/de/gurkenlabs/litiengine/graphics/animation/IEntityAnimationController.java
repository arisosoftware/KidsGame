...
public interface IEntityAnimationController extends IAnimationController, IEntityController {
	 ...
	 * animation playing that is defined to loop. This allows to specify animations
	 * that should be applied under certain conditions.
	 * 
	 * @param rule          The rule that must be fulfilled for the animation to be
	 *                      applied
	 * @param animationName The callback that evaluates the actual animation name
