...
public class DebugRenderer {
	...
	private static void drawMapId(final Graphics2D g, final IEntity entity) {
		...
		final String locationString = "[x:" + new DecimalFormat("##.##").format(entity.getX()) + ";y:"
	...
	private static void drawTileBoundingBox(final Graphics2D g, final IMap map, final Point2D location) {
		...
		TextRenderer.render(g, locationText, (float) (relative.getX() + playerTile.getWidth() + 3),
		...
		TextRenderer.render(g, sb.toString(), (float) (relative.getX() + playerTile.getWidth() + 3),
