...
public interface ICamera extends IUpdateable {
	...
	/**
	 * This method calculates to location for the specified point in relation to the
	 * focus map location of the camera.
	 *
	 * @param point the point
	 * @return the render location
	 */
	 ...
	 * location, after accounting for modifications such as clamping to the map.
	 * Event listeners attached to this camera are notified when the pan completes.
	 * 
	 ...
	 * Event listeners attached to this camera are notified when the pan completes.
	 * 
	 * @param x        the new X position for the camera once the panning is
	 *                 complete
	 * @param y        the new Y position for the camera once the panning is
	 *                 complete
	 * @param duration the number of frames between this call and when the pan
	 *                 completes
	 */
