...
public final class TextRenderer {
	 ...
	 * RenderingHints.VALUE_TEXT_ANTIALIAS_OFF as Anti-Aliasing method by standard.
	 * For other Anti-Aliasing options, please use the drawText()-variant with five
	 * parameters.
	 * 
	...
	public static void renderRotated(final Graphics2D g, final String text, final double x, final double y,
			final double angle, Object antiAliasing) {
		RenderingHints originalHints = g.getRenderingHints();
		g.setRenderingHint(RenderingHints.KEY_TEXT_ANTIALIASING, antiAliasing);
	...
	/**
	 * Draw text at the given coordinates with a maximum line width for automatic
	 * line breaks. This variant of drawTextWithAutomaticLinebreaks() uses
	 * RenderingHints.VALUE_TEXT_ANTIALIAS_OFF as Anti-Aliasing method by standard.
	 * For other Anti-Aliasing options, please use the
	...
	public static void renderWithLinebreaks(final Graphics2D g, final String text, Point2D location,
			final double lineWidth) {
	...
	/**
	 * Draw text at the given coordinates with a maximum line width for automatic
	 * line breaks and a provided Anti-Aliasing parameter.
	 * 
	 * @param g            the Graphics2D object to draw on
	 * @param text         the String to be distributed over all generated lines
	 * @param x            the min x coordinate
	 ...
	 */
	public static void renderWithLinebreaks(final Graphics2D g, final String text, final double x, final double y,
			final double lineWidth, final Object antiAliasing) {
		if (text == null || text.isEmpty()) {
			return;
		}
		RenderingHints originalHints = g.getRenderingHints();
	 ...
	 * This variant of drawTextWithShadow() uses RenderingHints.VALUE_ANTIALIAS_OFF
	 * as Anti-Aliasing method by standard. For other Anti-Aliasing options, please
	 * use the drawTextWithShadow()-variant with six parameters.
	 * 
	 * @param g            the Graphics2D object to draw on
	 * @param text         the String to be distributed over all generated lines
	 * @param x            the min x coordinate
	 ...
	 * @see RenderingHints
	 */
	public static void renderWithOutline(final Graphics2D g, final String text, final double x, final double y,
			final Color outlineColor) {
		renderWithOutline(g, text, x, y, outlineColor, RenderingHints.VALUE_ANTIALIAS_OFF);
	}

	public static void renderWithOutline(final Graphics2D g, final String text, Point2D location,
			final Color outlineColor) {
		renderWithOutline(g, text, location.getX(), location.getY(), outlineColor);
	}

	/**
	 * Draw text at the given coordinates with an outline in the provided color and
	 * a provided Anti-Aliasing parameter.
	 * 
	 * @param g            the Graphics2D object to draw on
	 * @param text         the String to be distributed over all generated lines
	 * @param x            the min x coordinate
	 ...
	 */
	public static void renderWithOutline(final Graphics2D g, final String text, final double x, final double y,
			final Color outlineColor, final Object antiAliasing) {
		if (text == null || text.isEmpty()) {
			return;
		}
