...
/**
 * The main update loop that executes the game logic by calling the update
 * functions on all registered components and entities.
 *
...
public final class GameLoop extends UpdateLoop implements IGameLoop {
	/**
	 * The tick {@link #getDeltaTime()} at which we consider the game not to run
	 * fluently anymore.
	 * <ul>
	...
	/**
	 * In addition to the normal base implementation, the <code>GameLoop</code>
	 * performs registered action at the required time and tracks some detailed
	 * metrics.
	 */
	@Override
