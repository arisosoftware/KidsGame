...
/**
 * This class contains basic information about a LITIengine game. The
 * information can be accessed via <code>Game.getInfo()</code> and the
 * infrastructure also internally uses this information e.g. to setup the main
 * window of the Game by providing an appropriate title.
 * <p>
 * It should be the first thing that you do in you application entry point to
 * setup or load this information. Note that it's possible to keep this
 * information in an XML file and load it up by calling
 * <code>Game.setInfo(String)</code>.
 * </p>
 * 
 * @see Game#info()
...
public class GameInfo extends CustomPropertyProvider {
	...
	/**
	 * Gets the {@link #getWebsite()} as an <code>URL</code> object that can be used
	 * to further process the information. (e.g. the web site can be opened in the
	 * browser).
	 * 
	...
	/**
	 * Gets the sub title of the game. It is basically an addendum to the
	 * {@link #getName()}.
	 * 
	 ...
	 * This will be used as the title of the game's window by default and includes
	 * the core information about the game:
	 * <ul>
	...
	/**
	 * Sets the game's description. This can be seen as additional information about
	 * the game and will not be part of the game's title.
	 * 
	 ...
	 * This is the most basic information about a game and will be part of the
	 * game's title.
	 * 
	 ...
	 * This is basically an addendum to the game's name and will also be part of the
	 * game's title.
	 * 
	 ...
	 * This is a textual representation of the game's version and will also be part
	 * of the game's title.<br>
