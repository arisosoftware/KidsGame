...
public interface IEntity {
	 ...
	 * 
	 * @return The EntityActionMap that holds all registered EntityActions for this
	 *         instance.
	 * 
	 * @see EntityActionMap
	...
	/**
	 * Performs an <code>EntityAction</code> that was previously registered for this
	 * entity.
	 * <p>
	 * <i>Does nothing in case no action has been registered for the specified
	 * <code>actionName</code>.</i>
	 * </p>
	 * 
	...
	/**
	 * Registers an <code>EntityAction</code> with the specified name. It's later
	 * possible to execute these actions on the entity by using the
	 * <code>Entity.perform(String actionName)</code> method.
	 * 
	 * @param name   The name of the action to be registered.
	 * @param action The action to be performed by the entity.
	 * 
	 * @return The created EntityAction instance; or null if the name or action
	...
	/**
	 * Determines whether this entity is being rendered with the layer it's
	 * originating from. This ignores the specified <code>RenderType</code> and
	 * makes the entity dependent upon the visibility of it's layer.
	 * <p>
	 * This can only be used, of course, if the entity is related to a
	 * <code>MapObject</code>. <br>
	 * This defaults to <code>false</code> if not explicitly set on the
	 * <code>MapObject</code>.
	 * </p>
	 * 
	 * @return True if the entity should be rendered with the layer of the
	 *         corresponding map object; otherwise false.
	 * 
	...
	/**
	 * This method provides the possibility to implement behavior whenever this
	 * entity was added to the environment.
	 * 
	...
	/**
	 * This method provides the possibility to implement behavior whenever this
	 * entity was removed from the environment.
	 * 
	 ...
	 * 
	 * @return True if the entity is loaded on the game's currently active
