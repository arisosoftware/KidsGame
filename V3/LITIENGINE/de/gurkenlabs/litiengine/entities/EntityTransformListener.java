...
/**
 * This listener provides callbacks for when an <code>Entity</code> was moved or
 * changed its size.
 */
public interface EntityTransformListener extends EventListener {

	/**
	 * This method is called whenever the location of an <code>IEntity</code> was
	 * changed.
	 * 
	...
	/**
	 * This method is called whenever the size of an <code>IEntity</code> was
	 * changed.
	 * 
