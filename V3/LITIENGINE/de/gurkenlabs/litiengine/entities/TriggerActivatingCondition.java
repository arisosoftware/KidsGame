...
/**
 * This listener provides a callback that allows to check conditions for
 * activating a <code>Trigger</code> and prevent the activation if necessary.
 */
public interface TriggerActivatingCondition extends EventListener {
	 ...
	 * @return The reason why the trigger cannot be activated or null if it can be
	 *         activated.
	 */
