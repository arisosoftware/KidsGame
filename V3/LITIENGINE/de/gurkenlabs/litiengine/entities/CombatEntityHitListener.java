...
/**
 * This listener provides callbacks for when an <code>ICombatEntity</code> was
 * hit.
 * 
...
public interface CombatEntityHitListener extends EventListener {
	 ...
	 * 
	 * @param event The event data that contains information about the entity, for
	 *              how much it was hit and the ability that caused the hit.
	 */
