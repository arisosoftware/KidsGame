...
public interface IMobileEntity extends ICollisionEntity {
	...
	/**
	 * Gets a value that defines how long it takes the entity to stop when slowing
	 * down from movements (in ms).
	 * 
	...
	/**
	 * Sets the acceleration for this entity. Acceleration is a value that defines
	 * how long it takes the entity to reach the full velocity when starting to move
	 * (in ms). *
	 * 
	...
	/**
	 * Sets the deceleration for this entity. deceleration is a value that defines
	 * how long it takes the entity to stop when slowing down from movements (in
	 * ms).
	 *
	 ...
	 *
	 * @param dest the destination point of the movement.
	 */
	public void setMoveDestination(Point2D dest);

	/**
	 * Sets the turn on move parameter for this entity. It specifies if the entity
	 * will change its angle to the direction of the move destination when moved.
	 *
	...
	/**
	 * Gets the turn on move parameter for this entity. It specifies if the entity
	 * will change its angle to the direction of the move destination when moved.
	 *
	 * @return true, if the entity will change its angle to the direction of the
	 *         move destination when being moved
	 */
