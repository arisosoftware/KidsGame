...
public class Creature extends CombatEntity implements IMobileEntity {
	...
	public Creature(String spritePrefix) {
		...
		if (spritePrefix != null) {
			...
			this.setSpritePrefix(
					ArrayUtilities.getRandom(EntityAnimationController.getDefaultSpritePrefixes(this.getClass())));
		}
	}
	...
	/**
	 * Gets the current sprite prefix of this instance. Overwriting this allows for
	 * a more sophisticated logic that determines the sprite to be used; e.g. This
	 * method could append certain properties of the creature (state, weapon, ...)
	 * to the default string. <br>
	 * <br>
	 * The value of this method will be used e.g. by the
	 * {@link CreatureAnimationController} to determine the animation that it should
	 * play.
	 * 
	...
	public void setMoveDestination(final Point2D dest) {
		...
		this.setAngle(
				(float) GeometricUtilities.calcRotationAngleInDegrees(this.getLocation(), this.getMoveDestination()));
	}
