...
/**
 * The class Attribute represents a numerical representation of a character
 * property that can be adjusted using {@link AttributeModifier}s.
 *
 * @param <T> The type of the actual attribute.
 */
